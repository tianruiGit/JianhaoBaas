...
public class Transform {
	 ...
	 * 
	 * @param table
	 *            必须指定Table的idColumn属性
	 * @param parentColumn
	 *            与Table的idColumn构成父子树
	 * @return
	 */
	 ...
	 *            ResultSet
	 * @param columns
	 *            指定要返回的列，以逗号分隔，如果为空则返回所有列；columns不仅用于限定返回的列范围，同时也用于指定返回列名的大小写
	 * @param count
	 *            行数，如果为null或小于零，则转换所有行
	 * @return
	 * @throws SQLException
	 */
	 ...
	 *            ResultSet
	 * @param columns
	 *            指定要返回的列，以逗号分隔，如果为空则返回所有列；columns不仅可以用于限定返回的列范围，同时也用于指定返回列名的大小写
	 * @return
	 * @throws SQLException
	 */
